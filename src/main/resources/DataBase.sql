...
insert into TripAdvizor_object (id, objec_name, number_of_star, free_room, busy_room, all_inclusive,
                                ultra_all_inclusive)
values ('0', 'Amway', '5', '50', '30', '1', '0'),
       ('1', 'Hotel_Lviv', '4', '50', '30', '1', '0'),
       ('2', '7Dniv', '3', '80', '20', '1', '0'),
       ('3', 'Ramada', '5', '50', '30', '1', '0'),
       ('4', 'Hotel_kyiv', '5', '50', '20', '1', '0'),
       ('5', 'Plaza', '4', '50', '30', '1', '0'),
       ('6', 'Radison', '5', '50', '30', '1', '0'),
       ('7', 'Amway_hotel', '3', '50', '30', '1', '0'),
       ('8', 'Radison', '5', '50', '20', '1', '0'),
       ('9', 'Amway', '5', '50', '30', '1', '0');
