...
public class TripAdvizor_object {
    ...
    public TripAdvizor_object(Integer id, String objec_name, String number_of_star, String free_room, String busy_room, String all_inclusive, String ultra_all_inclusive) {
        this.id = id;
    ...
    public TripAdvizor_object(String objec_name, String number_of_star, String free_room, String busy_room, String all_inclusive, String ultra_all_inclusive) {
         this(null, objec_name, number_of_star, free_room, busy_room, all_inclusive, ultra_all_inclusive);
    }
